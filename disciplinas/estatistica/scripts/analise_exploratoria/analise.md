#  Análise exploratória de dados (Covid)

## Base de dados utilizada

[Base de dados nacional do Covid 19](https://covid.saude.gov.br)


### Analise dos municipios e do estado de São Paulo.

![](./graphs/boxPlot_covid19.png "Estados e Municipios SP")

### Analise do municipio de Sorocaba (Sp)

![](./graphs/col_covid19.png "Sorocaba SP")
